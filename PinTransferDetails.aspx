<%@ Page Title="" Language="C#" MasterPageFile="~/SitePage.master" AutoEventWireup="true" CodeFile="PinTransferDetails.aspx.cs" Inherits="PinTransferDetails" EnableEventValidation="false" %>
                ...
                <div class="col-12 col-sm-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Pin Transfer Detail</h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-1">
                                <div class="clr">
        ...
        <asp:DropDownList ID="CmbKit" runat="server" CssClass="form-control ">
                                ...
                                <div class="col-md-12" runat="server" id="DivH" visible="true">
                                    ...
                                    <asp:DataGrid ID="DgPayment" runat="server" CssClass="table table-bordered" AutoGenerateColumns="False"
                                        AllowPaging="True" Width="90%" PageSize="20" OnPageIndexChanged="DgPayment_PageIndexChanged">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundColumn DataField="PinDate" HeaderText="Date"></asp:BoundColumn>
