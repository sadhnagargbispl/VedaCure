<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewTeamInfinity.aspx.cs" Inherits="ViewTeamInfinity" %>
        ...
        <div style="margin-bottom: 10px; padding-right: 20px; padding-left: 20px; padding-top: 20px">
            <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Comm" HeaderText="Generation Bonus"></asp:BoundField>
                </Columns>
            </asp:GridView>
        </div>
        <br />
