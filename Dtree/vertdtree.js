...
function Node(id, pid, category,doj,name, nodename,
                upliner,sponsor,leftbv,rightbv,url, 
                title, target, icon, iconOpen, open,
                leftjoin,rightjoin,level,upgradeDt) {
...
dTree.prototype.add = function(id, pid,category,doj, name, nodename,upliner,sponsor,leftbv,rightbv,url, title, target, icon, iconOpen, open,leftjoin,rightjoin,level,upgradeDt) {

	this.aNodes[this.aNodes.length] = new Node(id, pid,category,doj, name, nodename,upliner,sponsor,leftbv,rightbv,url, title, target, icon, iconOpen, open,leftjoin,rightjoin,level,upgradeDt);
...
dTree.prototype.toString = function() {
	...
	var str = '<div class="dtree" style="POSITION: Relative; TOP: 10px;" >\n';
...
dTree.prototype.node = function(node, nodeId) {
	...
	if (this.config.useIcons) {
		...
		strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.id + '</td>';  
		strTable+='</tr>';
...
//		strTable+='</tr>'; 
	...
	/*	strTable+='<tr>'; 
			...
			strTable+='<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>'+ node.upliner + '</font></td>';  
		strTable+='</tr>';
		
		

		strTable+='<tr>'; 
			strTable+='<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Spill :</font></td>';  
			strTable+='<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>'+ node.sponsor + '</font></td>'; 
		strTable+='</tr>';
    ...
    */		
		...
		strTable+='<tr>'; 
			strTable+='<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Joining Status :</font></td>'; 
			strTable+='<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>LEFT :' + node.leftjoin +', RIGHT :' +node.rightjoin +'</font></td>';  
		strTable+='</tr>';
		...
		strTable+='<tr>';
		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Active Member Status :</font></td>';
