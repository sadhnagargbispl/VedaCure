...
function Node(id, pid, category,doj,name, nodename,upliner,sponsor,leftbv,rightbv,url, title, target, icon, iconOpen, open,Rank,UpgradeDate) {
	this.id = id;
	this.pid = pid;
	this.name = name;
	this.url = url;
...
dTree.prototype.add = function(id, pid,category,doj, name, nodename,upliner,sponsor,leftbv,rightbv,url, title, target, icon, iconOpen, open,Rank,UpgradeDate) {
	this.aNodes[this.aNodes.length] = new Node(id, pid,category,doj, name, nodename,upliner,sponsor,leftbv,rightbv,url, title, target, icon, iconOpen, open,Rank,UpgradeDate);
};
...
dTree.prototype.node = function(node, nodeId) {
    ...
    if (this.config.useIcons) {
        ...
        strTable += '<tr>';
        strTable += '<td bgcolor=#277AB1><font color=#FFFFFF><strong>Member Name</strong></font></td>';
        strTable += '<td>' + node.nodename + '</td>';
        strTable += '</tr>';
        ...
        strTable += '<tr>';
        strTable += '<td bgcolor=#277AB1><font color=#FFFFFF><strong>Current Status</strong></font></td>';
        strTable += '<td>Direct :' + node.leftbv + ', Indirect :' + node.rightbv + ' </td>';
        strTable += '</tr>';
        strTable += '<tr>';
        strTable += '<td bgcolor=#277AB1><font color=#FFFFFF><strong>Joining Type</strong></font></td>';
        strTable += '<td>' + node.category + '&nbsp;</td>';
        strTable += '</tr>';
        if (node.UpgradeDate != 'undefined' && node.UpgradeDate != '') {
            strTable += '<tr>';
            strTable += '<td bgcolor=#277AB1><font color=#FFFFFF><strong>ActivationDate </strong></font></td>';
            strTable += '<td>' + node.UpgradeDate + '&nbsp;</td>';
            strTable += '</tr>';
        }
        if (node.Rank != 'undefined' && node.Rank != '') {
            strTable += '<tr>';
            strTable += '<td bgcolor=#277AB1><font color=#FFFFFF><strong>Rank </strong></font></td>';
            strTable += '<td>' + node.Rank + '&nbsp;</td>';
            strTable += '</tr>';
        }
        ...
        str += '<img id="i' + this.obj + nodeId + '" src="' + ((node._io) ? node.iconOpen : node.icon) + onMouse + ' alt="" />';
    }
